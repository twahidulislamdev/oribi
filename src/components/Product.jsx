...
const Product = ({ className, title, h5Txt, h6Txt, imgSrc, imgAlt }) => {
  return (
    <>
      <div className={`w-[23%]  hover:shadow-md rounded-lg  ${className}`}>
        <div className="relative group">
          <img src={imgSrc} alt={imgAlt} />
          <Badge className={"absolute top-5 left-5"} txt={"New"} />
          <div className="bg-white p-7.5 space-y-3 absolute bottom-0 left-0 w-full hidden group-hover:block transition-300 delay-300">
        ...
        <div className="">
          ...
          <h6 className={`text-sm text-[#767676] px-5 pb-10 pt-3 ${className}`}>
            {h6Txt}
          </h6>
        </div>
      </div>
